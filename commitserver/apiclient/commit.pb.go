...
type CommitHydratedManifestsRequest struct {
	// SourceRepo contains repository information for the source repository where manifests are read from.
	SourceRepo *v1alpha1.Repository `protobuf:"bytes,1,opt,name=sourceRepo,proto3" json:"sourceRepo,omitempty"`
	// DestRepo contains repository information for the destination repository where manifests will be committed to.
	DestRepo *v1alpha1.Repository `protobuf:"bytes,2,opt,name=destRepo,proto3" json:"destRepo,omitempty"`
	// SyncBranch is the branch Argo CD syncs from, i.e. the hydrated branch.
	SyncBranch string `protobuf:"bytes,3,opt,name=syncBranch,proto3" json:"syncBranch,omitempty"`
	...
	DrySha string `protobuf:"bytes,5,opt,name=drySha,proto3" json:"drySha,omitempty"`
	...
	Paths                []*PathDetails `protobuf:"bytes,7,rep,name=paths,proto3" json:"paths,omitempty"`
...
func (m *CommitHydratedManifestsRequest) GetSourceRepo() *v1alpha1.Repository {
	if m != nil {
		return m.SourceRepo
	}
	return nil
...
func (m *CommitHydratedManifestsRequest) GetDestRepo() *v1alpha1.Repository {
	if m != nil {
		return m.DestRepo
	}
	return nil
...
var fileDescriptor_cf3a3abbc35e3069 = []byte{
	...
	,
}
...
func (m *CommitHydratedManifestsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DestRepo != nil {
		{
			size, err := m.DestRepo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.SourceRepo != nil {
		{
			size, err := m.SourceRepo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CommitHydratedManifestsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SourceRepo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SourceRepo == nil {
				m.SourceRepo = &v1alpha1.Repository{}
			}
			if err := m.SourceRepo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DestRepo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DestRepo == nil {
				m.DestRepo = &v1alpha1.Repository{}
			}
			if err := m.DestRepo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
